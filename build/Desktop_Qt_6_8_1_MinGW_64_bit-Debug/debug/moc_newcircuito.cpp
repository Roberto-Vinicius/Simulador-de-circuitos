...
namespace {
struct qt_meta_tag_ZN11NewCircuitoE_t {};
} // unnamed namespace


#ifdef QT_MOC_HAS_STRINGDATA
static constexpr auto qt_meta_stringdata_ZN11NewCircuitoE = QtMocHelpers::stringData(
    "NewCircuito",
    "signNewCircuito",
    "",
    "numInputs",
...
Q_CONSTINIT static const uint qt_meta_data_ZN11NewCircuitoE[] = {
...
Q_CONSTINIT const QMetaObject NewCircuito::staticMetaObject = { {
    ...
    qt_meta_stringdata_ZN11NewCircuitoE.offsetsAndSizes,
    qt_meta_data_ZN11NewCircuitoE,
    qt_static_metacall,
    nullptr,
    qt_incomplete_metaTypeArray<qt_meta_tag_ZN11NewCircuitoE_t,
        // Q_OBJECT / Q_GADGET
...
void NewCircuito::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    ...
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        case 1: _t->on_NewCircuito_accepted(); break;
        default: ;
        }
    }
    if (_c == QMetaObject::IndexOfMethod) {
        ...
        {
            using _q_method_type = void (NewCircuito::*)(int , int , int );
            if (_q_method_type _q_method = &NewCircuito::signNewCircuito; *reinterpret_cast<_q_method_type *>(_a[1]) == _q_method) {
                *result = 0;
                return;
            }
        }
...
void *NewCircuito::qt_metacast(const char *_clname)
{
    ...
    if (!strcmp(_clname, qt_meta_stringdata_ZN11NewCircuitoE.stringdata0))
